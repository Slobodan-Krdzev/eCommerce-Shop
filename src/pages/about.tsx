...
import { AboutPageContentType } from "../types/types";
import Image from "next/image";

type AboutPageProps = {
  aboutData: AboutPageContentType;
}

const About: NextPage<AboutPageProps> = ( {aboutData: {
  title, fifth_content, second_content, third_content, first_image, second_image, second_title, fourth_content,author
}} ) => {
  return (
    <>
      <Head>
            ...
            <div className="col-11 col-md-5 col-lg-4 m-lr-auto">
              <div className="how-bor1 ">
                <div className="hov-img0">
                  <Image src={first_image} alt="IMG" width={370} height={370}/>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            ...
            <div className="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
              <div className="how-bor2">
                <div className="hov-img0">
                <Image src={`/${second_image}`} alt="IMG" width={370} height={370}/>
...
export const getStaticProps: GetStaticProps = async () => {
  ...
  const [aboutDataRes] = await Promise.all([
